				...
				if(comments_open()){
					...
					$args = array(
						...
						'fields' => apply_filters( 'comment_form_default_fields', array(
							'avatar' => '<div class="cmt-info-container"><div class="comment-user-avatar"><img src="' . iro_opt('vision_resource_basepath', 'https://xiaobai1103.cn/release/ucode-x/source/Sakurairo_Vision/@2.4/') . 'basic/avatar.jpeg"><div class="socila-check qq-check"><i class="fa fa-qq" aria-hidden="true"></i></div><div class="socila-check gravatar-check"><i class="fa fa-google" aria-hidden="true"></i></div></div>',
							'author' =>
